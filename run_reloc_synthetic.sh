...
python3 scripts/eval_synthetic.py --pred output-synthetic-online/scene_01.json --gt data/synthetic/gt/scene_01.json
python3 scripts/eval_synthetic.py --pred output-synthetic-online/scene_02.json --gt data/synthetic/gt/scene_02.json
python3 scripts/eval_synthetic.py --pred output-synthetic-online/scene_03.json --gt data/synthetic/gt/scene_03.json
python3 scripts/eval_synthetic.py --pred output-synthetic-online/scene_04.json --gt data/synthetic/gt/scene_04.json
python3 scripts/eval_synthetic.py --pred output-synthetic-online/scene_05.json --gt data/synthetic/gt/scene_05.json
python3 scripts/eval_synthetic.py --pred output-synthetic-online/scene_06.json --gt data/synthetic/gt/scene_06.json
python3 scripts/eval_synthetic.py --pred output-synthetic-online/scene_07.json --gt data/synthetic/gt/scene_07.json
python3 scripts/eval_synthetic.py --pred output-synthetic-online/scene_08.json --gt data/synthetic/gt/scene_08.json
python3 scripts/eval_synthetic.py --pred output-synthetic-online/scene_09.json --gt data/synthetic/gt/scene_09.json
python3 scripts/eval_synthetic.py --pred output-synthetic-online/scene_10.json --gt data/synthetic/gt/scene_10.json